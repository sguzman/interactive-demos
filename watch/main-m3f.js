...
import { refineTrainGeometry } from './train-m3f.js';
...
function setViewPreset(name) {
  ...
  if (name === 'stack' && stackGuides) {
    stackGuides.checked = true;
...
// -----------------------------------------------------------------------------
// Kinematics. M3f keeps the M3a ratio graph and M3e phase chain, but the visible
// train now uses true-pitch semantic gears and a clearance-aware axial stack.
// -----------------------------------------------------------------------------
